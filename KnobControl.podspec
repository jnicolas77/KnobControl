...
Pod::Spec.new do |spec|
  ...
  spec.homepage     = "https://github.com/jnicolas77/KnobControl.git"
  ...
  # Or just: spec.author    = "Julio Nicolas"
  # spec.authors            = { "Julio Nicolas" => "jnicolas.marcos@gmail.com" }
  # spec.social_media_url   = "https://twitter.com/Julio Nicolas"
  ...
  spec.source       = { :git => "https://github.com/jnicolas77/KnobControl.git", :tag => "#{spec.version}" }
